...
public abstract class Manager : SerializedMonoBehaviour,IObserver
{
    ...
    public void AssignEvents(ObserverOfficer observerOfficer)
    {
        ...
        observerOfficer.subjectEvents[ObserverSubjects.LevelReadyToPlay] += LevelReadyToPlayProcess;
        ...
        observerOfficer.subjectEvents[ObserverSubjects.UpdateFollow] += UpdateFollowProcess;
    ...
    public virtual void UpdateFollowProcess()
    {
        print("Manager UpdateFollowProcess");
    }
    public virtual void LevelReadyToPlayProcess()
    {
        print("Manager LevelReadyToPlayProcess");
    }
}
