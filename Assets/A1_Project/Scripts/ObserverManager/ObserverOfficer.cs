...
public class ObserverOfficer : MonoBehaviour
{
    ...
    event SubjectEventHandler LevelReadyToPlay;
    ...
    void AddEvents()
    {
        ...
        subjectEvents.Add(ObserverSubjects.LevelReadyToPlay, LevelReadyToPlay);
        ...
        subjectEvents.Add(ObserverSubjects.UpdateFollow, UpdateFollow);
    }
}
